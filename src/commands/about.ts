                ...
                new EmbedBuilder()
                    ...
                    .setFields([
                        ...
                        },
                        {
                            ...
                            value: t("strings:commands.about.message.uptime-desc", { lng, duration: toHumanReadableTime(Math.round(process.uptime()), lng), date: `<t:${Math.round((Date.now() / 1000) - (client.uptime/1000))}:D>`, time: `<t:${Math.round((Date.now() / 1000) - (client.uptime/1000))}:T>` })
                        },
                        {

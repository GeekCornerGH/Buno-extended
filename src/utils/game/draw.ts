...
export default (quota: {
    ...
    [...Array(amount)].forEach(() => {
        ...
        while (pickedCard[1] === 0 || (onlyDigits === true &&
            (pickedCard[0].endsWith("wild") ||
                pickedCard[0].endsWith("+4") ||
                pickedCard[0].endsWith("block") ||
                pickedCard[0].endsWith("reverse") ||
                pickedCard[0].endsWith("+2") ||
                pickedCard[0].endsWith("0")))) pickedCard = array[Math.floor(Math.random() * array.length)];
